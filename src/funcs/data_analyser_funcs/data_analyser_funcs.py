...
from src.prompts.data_analyser_prompts.data_analyser_prompt import DESIRED_OUTPUT_SYSTEM_PROMPT, DESIRED_OUTPUT_USER_PROMPT
from src.funcs.general.desired_output_definition import DesiredOutputRegistry, DesiredOutputDefinition
